        ...
        >
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md p-5">
            ...
            <p className="text-xs text-gray-500 mb-3">
              What would make Steward better? Goes straight to Scott.
            </p>
            <textarea
              value={text}
            ...
            <div className="flex gap-2 mt-4">
              ...
              <button
                ...
                className="flex-1 py-2.5 rounded-lg text-sm font-semibold text-white bg-steward-primary disabled:opacity-50"
              >
